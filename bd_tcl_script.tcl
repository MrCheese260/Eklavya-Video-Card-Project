...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins microblaze_0/M_AXI_IC] [get_bd_intf_pins ram_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins microblaze_0/M_AXI_DC] [get_bd_intf_pins ram_interconnect/S01_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DP [get_bd_intf_pins microblaze_0/M_AXI_DP] [get_bd_intf_pins perif_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins mdm_1/MBDEBUG_0] [get_bd_intf_pins microblaze_0/DEBUG]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins microblaze_0/DLMB] [get_bd_intf_pins microblaze_0_local_memory/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins microblaze_0/ILMB] [get_bd_intf_pins microblaze_0_local_memory/ILMB]
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports ddr3_sdram] [get_bd_intf_pins mig_7series_0/DDR3]
  connect_bd_intf_net -intf_net perif_interconnect_M00_AXI [get_bd_intf_pins axi_gpio_1/S_AXI] [get_bd_intf_pins perif_interconnect/M00_AXI]
  ...
  connect_bd_intf_net -intf_net perif_interconnect_M02_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins perif_interconnect/M02_AXI]
  ...
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports ck_a0] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net ck_rst_1 [get_bd_ports ck_rst] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_0_200M/ext_reset_in]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins perif_interconnect/ACLK] [get_bd_pins perif_interconnect/M00_ACLK] [get_bd_pins perif_interconnect/M01_ACLK] [get_bd_pins perif_interconnect/M02_ACLK] [get_bd_pins perif_interconnect/S00_ACLK] [get_bd_pins ram_interconnect/ACLK] [get_bd_pins ram_interconnect/S00_ACLK] [get_bd_pins ram_interconnect/S01_ACLK] [get_bd_pins rst_clk_wiz_0_200M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_200M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins perif_interconnect/ARESETN] [get_bd_pins perif_interconnect/M00_ARESETN] [get_bd_pins perif_interconnect/M01_ARESETN] [get_bd_pins perif_interconnect/M02_ARESETN] [get_bd_pins perif_interconnect/S00_ARESETN] [get_bd_pins ram_interconnect/ARESETN] [get_bd_pins ram_interconnect/S00_ARESETN] [get_bd_pins ram_interconnect/S01_ARESETN] [get_bd_pins rst_clk_wiz_0_200M/peripheral_aresetn]
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins mig_7series_0/aresetn] [get_bd_pins ram_interconnect/M00_ARESETN] [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn]
  connect_bd_net -net util_ds_buf_0_BUFG_O [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins util_ds_buf_0/BUFG_O]
