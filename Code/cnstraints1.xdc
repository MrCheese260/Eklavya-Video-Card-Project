...
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { red }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
...
set_property -dict {PACKAGE_PIN B4 IOSTANDARD LVCMOS33} [get_ports {reset_count[4]}]
set_property -dict {PACKAGE_PIN C4 IOSTANDARD LVCMOS33} [get_ports {reset_count[5]}]
set_property -dict {PACKAGE_PIN A1 IOSTANDARD LVCMOS33} [get_ports {reset_count[6]}]
set_property -dict {PACKAGE_PIN B1 IOSTANDARD LVCMOS33} [get_ports {reset_count[7]}]
...
set_property -dict { PACKAGE_PIN C14   IOSTANDARD LVCMOS33 } [get_ports { count[0]  }]; #IO_L1N_T0_AD0N_15 		Sch=ck_an_n[5]	ChipKit pin=A5
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { count[1] }]; #IO_L1P_T0_AD0P_15 		Sch=ck_an_p[5]	ChipKit pin=A5
## ChipKit Outer Analog Header - as Digital I/O
## NOTE: the following constraints should be used when using these ports as digital I/O.
set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { count[2] }]; #IO_0_35           	Sch=ck_a[0]		ChipKit pin=A0
set_property -dict { PACKAGE_PIN D8    IOSTANDARD LVCMOS33 } [get_ports { count[3] }]; #IO_L4P_T0_35      	Sch=ck_a[1]		ChipKit pin=A1
set_property -dict { PACKAGE_PIN C7    IOSTANDARD LVCMOS33 } [get_ports { count[4] }]; #IO_L4N_T0_35      	Sch=ck_a[2]		ChipKit pin=A2
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { count[5] }]; #IO_L6P_T0_35      	Sch=ck_a[3]		ChipKit pin=A3
set_property -dict { PACKAGE_PIN D7    IOSTANDARD LVCMOS33 } [get_ports { count[6] }]; #IO_L6N_T0_VREF_35 	Sch=ck_a[4]		ChipKit pin=A4
set_property -dict { PACKAGE_PIN D5    IOSTANDARD LVCMOS33 } [get_ports { count[7] }]; #IO_L11P_T1_SRCC_35	Sch=ck_a[5]		ChipKit pin=A5

## ChipKit Inner Analog Header - as Differential Analog Inputs
## NOTE: These ports can be used as differential analog inputs with voltages from 0-1.0V (ChipKit Analog pins A6-A11) or as digital I/O.
## WARNING: Do not use both sets of constraints at the same time!
## NOTE: The following constraints should be used with the XADC core when using these ports as analog inputs.
set_property -dict { PACKAGE_PIN B7    IOSTANDARD LVCMOS33 } [get_ports { count[8] }]; #IO_L2P_T0_AD12P_35	Sch=ad_p[12]	ChipKit pin=A6
set_property -dict { PACKAGE_PIN B6    IOSTANDARD LVCMOS33 } [get_ports { count[9] }]; #IO_L2N_T0_AD12N_35	Sch=ad_n[12]	ChipKit pin=A7
set_property -dict { PACKAGE_PIN E6    IOSTANDARD LVCMOS33 } [get_ports { count[10] }]; #IO_L5P_T0_AD13P_35	Sch=ad_p[13]	ChipKit pin=A8
